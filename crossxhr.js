...
////////////////
  ...
  var SWF_URL = "https://cdn.findawayworld.com/static/swf/vendor/crossxhr.swf"; // set if you want to hardcode path to crossxhr.swf
  ...
  function FlashHttpRequest_(parent) {
    ...
    this.addHeader = function (key, value) {
      gateway.addHeader(this.id, key, value);
    }
  ...
  function CrossXHR() {
    ...
    this.setRequestHeader = function (key, value) {
      if (obj) {
        ...
        queue.push(function () { obj.addHeader(key, value); });
      }
    }
